...
const CardItem = ({ id, year, make, model, type, img, fuelConsumption, engineSize, accessories, functionalities, rentalPrice, rentalCompany, address, rentalConditions, mileage }) => {
  console.log(accessories[0])
  return (
    <li className="h-[426px] flex flex-col justify-between ">
      <div className="rounded-xl hover:scale-105 duration-100 relative">
        <img className='object-cover h-[268px] ' src={img} alt='/buick_enclave' loading="lazy" />
        <svg className='absolute top-3.5 right-3.5' xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">

    ...
    <>
      <li className="h-[426px] flex flex-col justify-between ">
        <div className="hover:scale-105 duration-100 relative">
          <img className='object-cover h-[268px] rounded-xl' src={img} alt='/buick_enclave' loading="lazy" />
          {/* svg move in dif file */}
          <svg onClick={() => handleAddToFavorite(car)} className='absolute top-3.5 right-3.5' xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
